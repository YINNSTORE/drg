...
sleep 2
clear
curl "https://raw.githubusercontent.com/YINNSTORE/drg/main/menu/ssh-vpn.sh" | bash
sleep 2
...
[Unit]
Description=udp-custom by ©YinnVPN
...
#exp
cd /usr/bin
wget -O xp "https://raw.githubusercontent.com/YINNSTORE/drg/main/menu/xp.sh"
chmod +x xp
sleep 1
...
USERID=1210833546
KEY="6483602434:AAEiI6lGrvYq1Un3y-p0RSPwk-NGfyGUyyY"
TIMEOUT="10"
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Autoscript Premium By @YinnVpn ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "ADIOS"
